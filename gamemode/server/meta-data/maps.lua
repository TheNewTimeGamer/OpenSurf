...
function startPoint(minX,minY,minZ,maxX,maxY,maxZ,angle)
    obj = {minX = minX, minY = minY, minZ = minZ, maxX = maxX, maxY = maxY, maxZ = maxZ, angle = angle}
...
function endPoint(minX,minY,minZ,maxX,maxY,maxZ,angle)
    return startPoint(minX,minY,minZ,maxX,maxY,maxZ,angle)
end
...
maps["surf_beginner"] = map(
    startPoint(-440, 250, 320, 180, -50, 400, 90),
    endPoint(-6067, 4876, -263, -4556, 5230, -400, 90)
)
